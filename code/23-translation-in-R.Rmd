...
We will use the [DeepL](https://www.deepl.com/docs-api) API.
...
translate_text <- function(text, api_key, cache_file) {
  # Load existing cache
...
# Define your API key
api_key <- "71f834b4-7d20-c9c7-456d-61cfcdb8facd:fx"

# Usage:
result <- process_and_translate_text(here::here("data", "emigrationsutredningen.txt"), api_key, "output.xlsx", n_rows = 15)
