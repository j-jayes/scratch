...
df %>% ggplot(aes(year, value, colour = industry)) +
  ...
  labs(x = NULL, y = NULL, title = "Electricity as a share of energy use in different industries", colour = "Industry", caption = "Source: Lennart Schön") +
...
ggsave(filename = here::here("figures/schon-energy-share.jpeg"), device = "jpeg", width = 290, height = 231, units = "mm", dpi = 300)
